...
` +
    ...
    function Gt(e) {
      if (
        ((e = e || (typeof document < `u` ? document : void 0)), e === void 0)
      )
        return null;
      try {
    ...
    function Fc(e, t, n) {
      switch (t.tag) {
        ...
        case 19:
          ...
          if (
            ((r = (n & t.childLanes) !== 0),
            r || (oa(e, t, n, !1), (r = (n & t.childLanes) !== 0)),
            i)
          ) {
...
`,
    ...
    function Rf(e, t) {
      (e.crossOrigin ?? (e.crossOrigin = t.crossOrigin),
        e.referrerPolicy ?? (e.referrerPolicy = t.referrerPolicy),
        e.title ?? (e.title = t.title));
    }
    function zf(e, t) {
      (e.crossOrigin ?? (e.crossOrigin = t.crossOrigin),
        e.referrerPolicy ?? (e.referrerPolicy = t.referrerPolicy),
        e.integrity ?? (e.integrity = t.integrity));
    }
    var Bf = null;
    function Vf(e, t, n) {
      if (Bf === null) {
  ...
  S = [
    {
      ...
      icon: `👑`,
      text: `Ashi, you did not arrive with one dramatic moment. Somewhere between normal conversations, random laughs and little everyday things, you quietly became one of the most important parts of my days.`,
      note: `Some people enter your life slowly, then suddenly mean so much.`,
    },
    {
      chapter: `II`,
      title: `The name that belongs to you`,
      icon: `🐰`,
      text: `To everyone else, you are Ashi. To me, you are also Bauniii—a tiny name that somehow holds your caring, silly and teasing side all at once.`,
      note: `It is a small name with a lot of meaning.`,
    },
    {
      chapter: `III`,
      title: `The little things I remember`,
      icon: `🌷`,
      text: `Our video calls, the random topics, your teasing, your anger and those moments when neither of us wants to end the call—these are the memories I keep coming back to.`,
      note: `The little things were never little to me.`,
    },
    {
      chapter: `IV`,
      title: `The pages still ahead`,
      icon: `🪶`,
      text: `I do not need every future page to be perfect. I only want honesty, respect, understanding and many more reasons for us to laugh together.`,
      note: `The story keeps moving, and your place in it still matters.`,
    },
  ],
  C = [
    [
      `01`,
      `Your smile`,
      `It can make even a completely ordinary moment feel a little better.`,
    ],
    [
      `02`,
      `The way you care`,
      `You notice small things, and that quiet care never goes unnoticed.`,
    ],
    [
      `03`,
      `Your silly side`,
      `The random things you do often become the moments I remember most.`,
    ],
    [
      `04`,
      `Your strength`,
      `You handle more than you say and still manage to stay warm and kind.`,
    ],
    [
      `05`,
      `Simply you`,
      `There is no complicated reason. You being yourself is already enough.`,
    ],
  ],
  w = [
    {
      q: `Jaanuu, mera Aapko “Bauniii” bulana kaisa lagta hai?`,
      options: [
        `Bahut cute`,
        `Secretly bahut special`,
        `Main gussa karti hoon`,
        `All of these`,
      ],
    },
    {
      q: `Hamari video calls mein Aapka favourite part kya hai?`,
      options: [
        `Endless teasing`,
        `Random conversations`,
        `Ek-dusre ko dekhte rehna`,
        `Sab kuch`,
      ],
    },
    {
      q: `Jab main Aapko tease karta hoon, Aapka real reaction kya hota hai?`,
      options: [
        `Hansi aa jati hai`,
        `Gussa`,
        `Wapas tease karti hoon`,
        `Mood par depend karta hai`,
      ],
    },
    {
      q: `Hamare relationship ka overall vibe kya hai?`,
      options: [
        `Cute chaos`,
        `Comforting`,
        `Comedy show`,
        `In sabka perfect mix`,
      ],
    },
    {
      q: `Hamari perfect video call kaisi hogi?`,
      options: [
        `Late-night long call`,
        `Funny teasing wali call`,
        `Soft serious conversation`,
        `Bina kisi plan ki random call`,
      ],
    },
    {
      q: `Mera kaunsa version Aapko sabse achha lagta hai?`,
      options: [`Funny Ali`, `Caring Ali`, `Supportive Ali`, `Sab versions`],
    },
    {
      q: `Jab Aap upset hoti hain, mujhe kya karna chahiye?`,
      options: [
        `Calmly baat karni chahiye`,
        `Mujhe hasana chahiye`,
        `Thoda time dena chahiye`,
        `Pyaar se reassure karna chahiye`,
      ],
    },
    {
      q: `Aap hamare relationship mein aur kya chahti hain?`,
      options: [
        `Zyada video calls`,
        `Zyada cute surprises`,
        `Zyada funny moments`,
        `Bas aise hi saath aur understanding`,
      ],
    },
    {
      q: `Mere diye hue nicknames mein Aapko kaunsa sabse special lagta hai?`,
      options: [
        `Hamster`,
        `Bauniii`,
        `Chuhiya`,
        `Ek naya secret nickname chahiye`,
      ],
    },
    {
      q: `Is surprise ka Aapka favourite part kya raha?`,
      options: [
        `Royal page-flip story`,
        `Cute animations`,
        `Personalized games`,
        `Final letter`,
      ],
    ...
    {
      q: `Hamari next perfect memory kya honi chahiye?`,
      options: [
        `Ek extra-long video call`,
        `Movie night`,
        `Peaceful walk`,
        `Unexpected surprise`,
      ],
    ...
    {
      q: `Is surprise ke baad mujhe kya milna chahiye?`,
      options: [
        `Ek big smile`,
        `Thank-you message`,
        `Extra teasing`,
        `Ye sab kuch`,
        `Kuch aur—personal mein bataungi`,
      ],
    },
  ],
  ee = [
    `Aapka cute aur thoda silly side har normal moment ko bhi special bana deta hai.`,
    `Aapki teasing ke bina hamari video calls bilkul adhoori si lagti hain.`,
    `Aapse video call par baat karna din ke sabse achhe moments mein se ek hota hai.`,
    `Aapka gussa aur uske peeche chhupi smile bahut cute lagti hai.`,
    `Aapki chhoti-chhoti baatein bhi bahut important hoti hain.`,
    `Betuuu, Aap jaisi hain—cute, perfect, silly aur teasing wali—waise hi bahut special hain.`,
  ],
  te = [
    {
      q: `Main Aapko sabse zyada kis naam se bulata hoon?`,
      options: [`Bauniii`, `Madam Ji`, `Miss Ashi`],
      answer: 0,
    },
    {
      q: `Hamari calls ka sabse special part kya hota hai?`,
      options: [
        `Sirf serious baatein`,
        `Teasing aur random baatein`,
        `Bilkul silence`,
      ],
      answer: 1,
    },
    {
      q: `Aap gussa hoti hain to main usually kya karta hoon?`,
      options: [
        `Aur tease karta hoon`,
        `Call cut kar deta hoon`,
        `Bilkul chup ho jata hoon`,
      ],
      answer: 0,
    },
    {
      q: `Ye poora surprise maine kis ke liye banaya hai?`,
      options: [`Aapke liye`, `Mere liye`, `Pookie cat ke liye`],
      answer: 0,
    },
  ],
  ne = [
    `Nahi, galat 😭 Zyada tease Aapko main hi karta hoon.`,
    `Woh to zindagi bhar karunga main 😌`,
    `Nahi, galat 😭 Zyada tease Aapko main hi karta hoon.`,
  ],
  T = [
    `Dher saari kisses wali coupon—jab milenge tab claim kar lena 😌`,
    `Ek mini-vlog Snap, poora din ki chhoti-chhoti clips ke saath—sirf Aapke liye.`,
    `Ek pyara sa voice note jisme main Aapki dil se tareef karunga.`,
    `Next video call par Aapki pasand ka ek cute sa challenge main bina mana kiye karunga 😭`,
    `Ek handwritten-style message jisme main hamari favourite memory likhunga.`,
    `Aapki choice ka ek chhota surprise—jo Aap bolo, main honestly poora karne ki koshish karunga ✨`,
  ],
  re = [
    `🐻`,
    `☁️`,
...
function ie() {
  ...
  return (0, x.jsxs)(x.Fragment, {
    children: [
      (0, x.jsx)(`div`, { className: `aurora a1` }),
      (0, x.jsx)(`div`, { className: `aurora a2` }),
      (0, x.jsx)(`div`, {
...
function ae() {
  let [e, t] = (0, b.useState)(!1),
    ...
    [g, _] = (0, b.useState)(!1),
    [v, y] = (0, b.useState)([]),
    [ae, oe] = (0, b.useState)(0),
    [se, ce] = (0, b.useState)(0),
    [le, E] = (0, b.useState)(!1),
    [D, ue] = (0, b.useState)(!1),
    [de, fe] = (0, b.useState)(0),
    [pe, O] = (0, b.useState)(null),
    [k, me] = (0, b.useState)(null),
    [he, ge] = (0, b.useState)(-1),
  ...
  (0, b.useEffect)(() => {
    ...
    let t = document.documentElement,
      n = Array.from(document.querySelectorAll(`main > section`)),
      r = null;
      ...
      a = () => {
        i ||
          (i = window.requestAnimationFrame(() => {
            ...
            (Te.current &&
              (Te.current.style.width = `${e ? (scrollY / e) * 100 : 0}%`),
              (i = 0));
          }));
      },
      o = () => {
        t.classList.toggle(`page-hidden`, document.hidden);
      };
    return (
      a(),
      o(),
      addEventListener(`scroll`, a, { passive: !0 }),
      ...
      () => {
        (i && window.cancelAnimationFrame(i),
          ...
          t.classList.remove(`page-hidden`));
      }
    );
  }, [e]);
  let Ee = (e) => {
      ...
      let t = Date.now();
      (we((n) => [...n.slice(-8), { id: t, x: e.clientX, y: e.clientY }]),
        window.setTimeout(() => we((e) => e.filter((e) => e.id !== t)), 900));
    },
    De = (e) => {
      i ||
        (a(e),
        window.setTimeout(() => {
          (r((t) =>
            e === `next` ? Math.min(S.length - 1, t + 1) : Math.max(0, t - 1),
          ),
            a(null));
        }, 380));
    },
    Oe = (e) => {
      (e === te[ae].answer && ce((e) => e + 1),
        ae === te.length - 1 ? E(!0) : oe((e) => e + 1));
    },
    ke = (e) => {
      u ||
        (s((t) => {
...
`);
    ...
    Me = (e) => {
      y((t) => (t.includes(e) ? t : [...t, e]));
    },
    Ne = (e) => {
      e === de
        ? fe((e) => Math.min(4, e + 1))
        : (O(e), window.setTimeout(() => O(null), 500));
    };
  return e
    ? (0, x.jsxs)(`main`, {
        onPointerDown: Ee,
        children: [
          ...
          (0, x.jsx)(`div`, { className: `progress`, ref: Te }),
          (0, x.jsxs)(`header`, {
            className: `love-crest`,
            "aria-label": `A little surprise for Ashi`,
            children: [
              (0, x.jsx)(`span`, {
                className: `crest-line crest-line-left`,
                "aria-hidden": `true`,
                children: (0, x.jsx)(`i`, { children: `✦` }),
              }),
              (0, x.jsxs)(`a`, {
                className: `crest-center`,
                href: `#home`,
                children: [
                  (0, x.jsxs)(`span`, {
                    className: `crest-monogram`,
                    "aria-hidden": `true`,
                    children: [
                  ...
                  (0, x.jsxs)(`span`, {
                    className: `crest-copy`,
                    children: [
                      (0, x.jsx)(`small`, {
                        children: `ALI'S LITTLE SURPRISE`,
                      }),
                      (0, x.jsx)(`strong`, { children: `For Ashi, with love` }),
                    ],
                  }),
                  (0, x.jsx)(`span`, {
              ...
              (0, x.jsx)(`span`, {
                className: `crest-line crest-line-right`,
                "aria-hidden": `true`,
                children: (0, x.jsx)(`i`, { children: `♡` }),
              }),
            ],
          ...
          (0, x.jsxs)(`section`, {
            ...
            children: [
              (0, x.jsx)(`div`, {
                ...
                children: `✦ 1st August · Girlfriend Day · a special edition for Ashi ✦`,
              }),
              (0, x.jsx)(`div`, {
              ...
              (0, x.jsxs)(`div`, {
                ...
                children: [
                  (0, x.jsx)(`span`, {
                    ...
                    children: `Dear Bauniii 🐰`,
                  }),
                  (0, x.jsx)(`p`, {
                    className: `handwriting`,
                    children: `Welcome to your little universe`,
                  }),
                  (0, x.jsxs)(`h1`, {
                    children: [
                      `Every fairytale`,
                      (0, x.jsx)(`br`, {}),
                      `needs its `,
                      (0, x.jsx)(`em`, { children: `Ashi.` }),
                    ],
                  }),
                  (0, x.jsx)(`p`, {
                    className: `hero-v2-note`,
                    children: `So here is a whole tiny kingdom made from soft colours, silly games, royal pages and all the little things that deserve to make you smile.`,
                  }),
                  (0, x.jsxs)(`button`, {
                    className: `royal-button`,
                    onClick: () =>
                      document
                        .querySelector(`#storybook`)
              ...
              (0, x.jsxs)(`div`, {
                ...
                children: [
                  (0, x.jsx)(`div`, { className: `scene-halo` }),
                  (0, x.jsx)(`img`, {
                    src: `./assets/kawaii-bear-cat-sticker.webp`,
                    alt: `Cute bear and cat in Ashi's little world`,
                    width: `800`,
                    height: `800`,
                    loading: `eager`,
                    decoding: `async`,
                  ...
                  (0, x.jsxs)(`span`, {
                    className: `sticker-tag tag-a`,
                    children: [
                      `Ashi`,
                      (0, x.jsx)(`br`, {}),
                      (0, x.jsx)(`small`, { children: `the queen` }),
                    ],
                  }),
                  (0, x.jsxs)(`span`, {
                    className: `sticker-tag tag-b`,
                    children: [
                      `100%`,
                      (0, x.jsx)(`br`, {}),
                      (0, x.jsx)(`small`, { children: `adorable` }),
                    ],
                  }),
                  (0, x.jsx)(`span`, {
                    className: `floating-emoji fe1`,
                    children: `🌷`,
                  }),
                  (0, x.jsx)(`span`, {
                    className: `floating-emoji fe2`,
                    children: `☁️`,
                  }),
                  (0, x.jsx)(`span`, {
                    className: `floating-emoji fe3`,
                    children: `🎀`,
                  }),
                ],
              }),
              (0, x.jsxs)(`div`, {
                className: `swipe-note`,
                children: [
                  `swipe down `,
                  (0, x.jsx)(`span`, { children: `↓` }),
                ],
          ...
          (0, x.jsx)(`section`, {
            ...
            "aria-label": `Ashi Bauniii`,
            children: (0, x.jsxs)(`div`, {
              children: [
                (0, x.jsx)(`span`, { children: `ASHI` }),
                ` ♡ `,
                (0, x.jsx)(`em`, { children: `BAUNIII` }),
                ` ✦ `,
                (0, x.jsx)(`span`, { children: `ASHI` }),
                ` ♡ `,
                (0, x.jsx)(`em`, { children: `BAUNIII` }),
          ...
          (0, x.jsxs)(`section`, {
            ...
            children: [
              (0, x.jsxs)(`div`, {
                ...
                children: [
                  (0, x.jsx)(`span`, {
                    children: `chapter one · written from the heart`,
                  }),
                  (0, x.jsxs)(`h2`, {
                    children: [
                      `Little moments that made`,
                      (0, x.jsx)(`br`, {}),
                      (0, x.jsx)(`em`, { children: `you unforgettable` }),
                    ],
                  }),
                  (0, x.jsx)(`p`, {
                    children: `Turn each royal page slowly. Every chapter holds something I have wanted you to know.`,
                  }),
                ],
              }),
              (0, x.jsxs)(`div`, {
                className: `book-stage reveal`,
                children: [
                  (0, x.jsx)(`span`, {
                    className: `book-spark s1`,
                    children: `✦`,
                  }),
                  (0, x.jsx)(`span`, {
                    className: `book-spark s2`,
                    children: `♡`,
                  }),
                  (0, x.jsx)(`span`, {
                    className: `book-spark s3`,
                    children: `✧`,
                  }),
                  (0, x.jsxs)(
                    `div`,
                    {
                      className: `royal-book ${i ? `turn-${i}` : ``}`,
                      children: [
                        (0, x.jsx)(`div`, { className: `book-spine` }),
                        (0, x.jsxs)(`article`, {
                          className: `parchment-page`,
                          children: [
                            (0, x.jsx)(`div`, { className: `page-corner pc1` }),
                            (0, x.jsx)(`div`, { className: `page-corner pc2` }),
                            (0, x.jsxs)(`span`, {
                              className: `page-chapter`,
                              children: [`Chapter `, S[n].chapter],
                            }),
                            (0, x.jsx)(`div`, {
                              className: `page-icon`,
                              children: S[n].icon,
                            }),
                            (0, x.jsx)(`h3`, { children: S[n].title }),
                            (0, x.jsx)(`span`, {
                              className: `royal-divider`,
                              children: `❦`,
                            }),
                            (0, x.jsx)(`p`, { children: S[n].text }),
                            (0, x.jsx)(`i`, { children: S[n].note }),
                            (0, x.jsxs)(`div`, {
                              className: `wax-seal`,
                              children: [
                                `A`,
                  ...
                  (0, x.jsx)(`p`, {
                    className: `page-tip`,
                    children: `tap the arrows to flip the royal pages`,
                  }),
                ],
              }),
            ],
          ...
          (0, x.jsxs)(`section`, {
            ...
            children: [
              (0, x.jsxs)(`div`, {
                className: `section-title light reveal`,
                children: [
                  (0, x.jsx)(`span`, {
                    children: `chapter two · the things i always notice`,
                  }),
                  (0, x.jsxs)(`h2`, {
                    children: [
                      `Five things that make`,
                      (0, x.jsx)(`br`, {}),
                      (0, x.jsx)(`em`, { children: `you wonderfully unique.` }),
                    ],
                  }),
                ],
              }),
              (0, x.jsx)(`div`, {
                ...
                children: C.map((e, t) =>
                  (0, x.jsxs)(
                    `article`,
                    {
                      className: `reason-row reveal`,
                      style: { transitionDelay: `${t * 0.08}s` },
                      children: [
                        (0, x.jsx)(`b`, { children: e[0] }),
                        (0, x.jsxs)(`div`, {
                          children: [
                            (0, x.jsx)(`h3`, { children: e[1] }),
                            (0, x.jsx)(`p`, { children: e[2] }),
                          ],
                        }),
                        (0, x.jsx)(`span`, {
                          children: [`☀️`, `🫶`, `🍓`, `🌙`, `👑`][t],
          ...
          (0, x.jsxs)(`aside`, {
            className: `love-whisper reveal`,
            "aria-label": `A love note from Ali`,
            children: [
              (0, x.jsx)(`i`, { children: `♡` }),
              (0, x.jsx)(`span`, { children: `I love you, Ashi` }),
              (0, x.jsx)(`b`, { children: `in every ordinary little moment` }),
              (0, x.jsx)(`i`, { children: `♡` }),
            ],
          }),
          (0, x.jsxs)(`section`, {
            ...
            children: [
              (0, x.jsxs)(`div`, {
                ...
                children: [
                  (0, x.jsx)(`span`, {
                    children: `chapter three · a tiny royal questionnaire`,
                  }),
                  (0, x.jsxs)(`h2`, {
                    children: [
                      `Only Bauniii Can `,
                      (0, x.jsx)(`em`, { children: `Answer 🐰` }),
                    ],
                  }),
                  (0, x.jsx)(`p`, {
                    children: `Jaanuu, har answer sirf Aapka hai—jo dil kahe wahi choose karna. ♡`,
                  }),
                ],
              }),
              (0, x.jsx)(`div`, {
                className: `bauniii-quiz-shell reveal`,
                children: f
                  ? (0, x.jsxs)(`div`, {
                      className: `bauniii-results`,
                      children: [
                        (0, x.jsxs)(`div`, {
                          className: `result-celebration`,
                          "aria-hidden": `true`,
                          children: [
                            (0, x.jsx)(`span`, {
                              className: `result-crown`,
                              children: `♔`,
                            }),
                            (0, x.jsx)(`span`, {
                              className: `result-spark rs1`,
                              children: `✦`,
                            }),
                            (0, x.jsx)(`span`, {
                              className: `result-spark rs2`,
                              children: `✧`,
                            }),
                            (0, x.jsx)(`span`, {
                              className: `result-spark rs3`,
                              children: `♡`,
                            }),
                            (0, x.jsx)(`img`, {
                              src: `./assets/kawaii-bear-cat-sticker.webp`,
                        ...
                        (0, x.jsx)(`span`, {
                          ...
                          children: `✦ all twelve royal answers are ready ✦`,
                        }),
                        (0, x.jsx)(`h3`, { children: `Bauniii’s Answers ♡` }),
                        (0, x.jsx)(`p`, {
                          className: `result-intro`,
                          children: `Bauniii, Aapne apne perfect little world ke liye yeh choose kiya:`,
                        }),
                        (0, x.jsx)(`div`, {
                          ...
                          children: w.map((e, t) =>
                            (0, x.jsxs)(
                              `article`,
                              {
                                style: { animationDelay: `${t * 0.055}s` },
                                children: [
                                  (0, x.jsx)(`span`, {
                                  ...
                                  (0, x.jsxs)(`div`, {
                                    children: [
                                      (0, x.jsx)(`small`, { children: e.q }),
                                      (0, x.jsx)(`b`, {
                                        children: e.options[o[t]],
                                      }),
                                    ],
                                  }),
                                  (0, x.jsx)(`i`, {
                        ...
                        (0, x.jsxs)(`div`, {
                          ...
                          children: [
                            (0, x.jsxs)(`button`, {
                              className: `copy-answers`,
                              onClick: Ae,
                              children: [
                                (0, x.jsx)(`span`, { children: m ? `✓` : `♡` }),
                                m ? `Answers Copied!` : `Copy My Answers`,
                              ],
                            }),
                            (0, x.jsxs)(`button`, {
                        ...
                        (0, x.jsxs)(`p`, {
                          className: `privacy-note result-privacy`,
                          children: [
                            (0, x.jsx)(`span`, { children: `♙` }),
                            ` Nothing was saved or sent automatically.`,
                          ],
                        }),
                        (0, x.jsx)(`div`, {
                          className: `falling-result-hearts`,
                          "aria-hidden": `true`,
                          children: Array.from({ length: 8 }, (e, t) =>
                            (0, x.jsx)(
                              `i`,
                              {
                                style: {
                                  left: `${(t * 37) % 96}%`,
                                  animationDelay: `${-(t % 8) * 0.55}s`,
                                  animationDuration: `${4.5 + (t % 5) * 0.55}s`,
                                },
                                children: t % 3 == 0 ? `✦` : `♥`,
                              },
                              t,
                  ...
                  : (0, x.jsxs)(x.Fragment, {
                      children: [
                        (0, x.jsxs)(`div`, {
                          className: `bauniii-progress`,
                          "aria-label": `Question ${c + 1} of ${w.length}`,
                          children: [
                            (0, x.jsxs)(`div`, {
                              className: `bauniii-progress-copy`,
                              children: [
                                (0, x.jsxs)(`span`, {
                                  children: [
                                    `Question `,
                                ...
                                (0, x.jsxs)(`b`, {
                                  children: [c + 1, ` / `, w.length],
                                }),
                              ],
                            }),
                            (0, x.jsx)(`div`, {
                              className: `bauniii-progress-track`,
                              children: (0, x.jsx)(`i`, {
                                style: {
                                  width: `${((c + 1) / w.length) * 100}%`,
                                },
                              }),
                            }),
                            (0, x.jsx)(`div`, {
                              className: `bauniii-progress-dots`,
                              "aria-hidden": `true`,
                              children: w.map((e, t) =>
                                (0, x.jsx)(
                                  `i`,
                        ...
                        (0, x.jsxs)(
                          `article`,
                          {
                            className: `bauniii-question-card ${u ? `leaving` : ``}`,
                            children: [
                              (0, x.jsx)(`div`, {
                                className: `question-crown`,
                                "aria-hidden": `true`,
                                children: `♔`,
                              }),
                              (0, x.jsx)(`span`, {
                                className: `question-rabbit`,
                                "aria-hidden": `true`,
                                children: `🐰`,
                              }),
                              (0, x.jsx)(`small`, {
                                children: `Only Ashi can answer this`,
                              }),
                              (0, x.jsx)(`h3`, { children: w[c].q }),
                              (0, x.jsx)(`div`, {
                                className: `bauniii-options ${w[c].options.length === 5 ? `has-five` : ``}`,
                                children: w[c].options.map((e, t) =>
                                  (0, x.jsxs)(
                                    `button`,
                                    {
                                      className: o[c] === t ? `selected` : ``,
                                      disabled: u,
                                      onClick: () => ke(t),
                                      children: [
                                        (0, x.jsx)(`span`, {
                              ...
                              (0, x.jsxs)(`p`, {
                                ...
                                children: [
                                  (0, x.jsx)(`span`, { children: `♙` }),
                                  ` Your answers stay private in this browser unless you copy them yourself.`,
                                ],
                              }),
                            ],
                          },
          ...
          (0, x.jsxs)(`section`, {
            ...
            children: [
              (0, x.jsxs)(`div`, {
                ...
                children: [
                  (0, x.jsx)(`span`, {
                    children: `six little notes · only for you`,
                  }),
                  (0, x.jsxs)(`h2`, {
                    children: [
                      `Bauniii Appreciation `,
                      (0, x.jsx)(`em`, { children: `Vault 🐰` }),
                    ],
                  }),
                  (0, x.jsx)(`p`, {
                    children: `Ashi, royal treasure box par tap kijiye—har envelope mein Aapke liye ek chhota sa special note hai. ♡`,
                  }),
                ],
              }),
              (0, x.jsxs)(`div`, {
                className: `vault-shell reveal ${g ? `is-unlocked` : ``} ${v.length === ee.length ? `is-complete` : ``}`,
                children: [
                  (0, x.jsxs)(`span`, {
                    className: `vault-sticker vault-bunny`,
                    "aria-hidden": `true`,
                    children: [`🐰`, (0, x.jsx)(`i`, { children: `for you` })],
                  }),
                  (0, x.jsxs)(`span`, {
                    className: `vault-sticker vault-cat`,
                    "aria-hidden": `true`,
                    children: [`🐱`, (0, x.jsx)(`i`, { children: `tap tap!` })],
                  }),
                  (0, x.jsx)(`span`, {
                    className: `vault-float vf1`,
                    "aria-hidden": `true`,
                    children: `♡`,
                  }),
                  (0, x.jsx)(`span`, {
                    className: `vault-float vf2`,
                    "aria-hidden": `true`,
                    children: `✦`,
                  }),
                  (0, x.jsx)(`span`, {
                    className: `vault-float vf3`,
                    "aria-hidden": `true`,
                    children: `♥`,
                  }),
                  (0, x.jsxs)(`button`, {
                    className: `vault-chest ${g ? `open` : ``}`,
                    onClick: () => _(!0),
                    disabled: g,
                    "aria-label": g
                      ? `Bauniii appreciation vault opened`
                      : `Open Bauniii appreciation vault`,
                    children: [
                      (0, x.jsx)(`span`, { className: `chest-glow` }),
                      (0, x.jsx)(`span`, {
                        className: `chest-lid`,
                        children: (0, x.jsx)(`i`, { children: `✦　♡　✦` }),
                      }),
                      (0, x.jsxs)(`span`, {
                        ...
                        children: [
                          (0, x.jsx)(`i`, { children: `♔` }),
                          (0, x.jsx)(`b`, { children: `BAUNIII` }),
                        ],
                      }),
                      (0, x.jsxs)(`span`, {
                        className: `chest-lock`,
                        children: [`A`, (0, x.jsx)(`small`, { children: `♡` })],
                      }),
                    ],
                  }),
                  g
                    ? (0, x.jsxs)(x.Fragment, {
                        children: [
                          (0, x.jsxs)(`p`, {
                            className: `vault-instruction opened`,
                            children: [
                              (0, x.jsx)(`span`, { children: `♡` }),
                              ` Ashi, envelopes par ek-ek karke tap kijiye `,
                              (0, x.jsx)(`span`, { children: `♡` }),
                            ],
                          }),
                          (0, x.jsx)(`div`, {
                            className: `vault-envelope-grid`,
                            "aria-live": `polite`,
                            children: ee.map((e, t) => {
                              let n = v.includes(t);
                              return (0, x.jsxs)(
                                `button`,
                                {
                                  className: `vault-note ${n ? `is-open` : ``}`,
                                  onClick: () => Me(t),
                                  "aria-expanded": n,
                                  children: [
                                    (0, x.jsxs)(`span`, {
                                      className: `vault-envelope-art`,
                                      "aria-hidden": `true`,
                                      children: [
                                        (0, x.jsx)(`i`, {
                                          className: `vault-envelope-back`,
                                        }),
                                        (0, x.jsx)(`i`, {
                                          className: `vault-envelope-flap`,
                                        }),
                                        (0, x.jsxs)(`b`, {
                                          className: `vault-envelope-seal`,
                                          children: [
                                            t + 1,
                                            (0, x.jsx)(`small`, {
                                              children: `♡`,
                                    ...
                                    (0, x.jsx)(`span`, {
                                      className: `vault-note-label`,
                                      children: n
                                        ? `Royal note ${t + 1}`
                                        : `Envelope ${t + 1} · tap to open`,
                                    }),
                                    (0, x.jsx)(`span`, {
                                      className: `vault-paper-wrap`,
                                      children: (0, x.jsxs)(`span`, {
                                        className: `vault-paper`,
                                        children: [
                                          (0, x.jsx)(`small`, {
                                            children: `✦ especially for you ✦`,
                                          }),
                                          (0, x.jsx)(`strong`, { children: e }),
                                          (0, x.jsx)(`i`, { children: `♡` }),
                                        ],
                                      }),
                                    }),
                    ...
                    : (0, x.jsxs)(`p`, {
                        className: `vault-instruction`,
                        children: [
                          (0, x.jsx)(`span`, { children: `✦` }),
                          ` Aap box par tap karke apna appreciation vault kholiye `,
                          (0, x.jsx)(`span`, { children: `✦` }),
                        ],
                      }),
                  v.length === ee.length &&
                    (0, x.jsxs)(`div`, {
                      className: `vault-crown-finale`,
                      role: `status`,
                      children: [
                        (0, x.jsx)(`div`, {
                          className: `royal-final-crown`,
                          "aria-hidden": `true`,
                          children: `♛`,
                        }),
                        (0, x.jsx)(`span`, {
                          children: `all six envelopes opened`,
                        }),
                        (0, x.jsx)(`h3`, {
                          children: `This Little Crown Belongs to Bauniii 👑`,
                        }),
                        (0, x.jsx)(`p`, {
                          children: `Ashi, yeh little royal crown sirf Aapka hai. ♡`,
                        }),
                      ],
                    }),
                  v.length === ee.length &&
                    (0, x.jsx)(`div`, {
                      className: `vault-confetti`,
                      "aria-hidden": `true`,
                      children: Array.from({ length: 8 }, (e, t) =>
                        (0, x.jsx)(
                          `i`,
                          {
                            style: {
                              left: `${(t * 31) % 96}%`,
                              animationDelay: `${-(t % 7) * 0.28}s`,
                              animationDuration: `${3.8 + (t % 4) * 0.45}s`,
                            },
                            children: [`♡`, `✦`, `·`, `♥`][t % 4],
                          },
                          t,
          ...
          (0, x.jsxs)(`aside`, {
            className: `love-whisper dark reveal`,
            "aria-label": `A love note from Ali`,
            children: [
              (0, x.jsx)(`i`, { children: `✦` }),
              (0, x.jsx)(`span`, { children: `Love you, Betaaa` }),
              (0, x.jsx)(`b`, {
                children: `more than these pages could ever explain`,
              }),
              (0, x.jsx)(`i`, { children: `✦` }),
            ],
          }),
          (0, x.jsxs)(`section`, {
            ...
            children: [
              (0, x.jsxs)(`div`, {
                ...
                children: [
                  (0, x.jsx)(`span`, {
                    children: `chapter four · our secret arcade`,
                  }),
                  (0, x.jsxs)(`h2`, {
                    children: [
                      `Five little games from`,
                      (0, x.jsx)(`br`, {}),
                      (0, x.jsx)(`em`, { children: `our story` }),
                    ],
                  }),
                  (0, x.jsx)(`p`, {
                    children: `Video calls, teasing aur hamari funny little moments se inspired—har game sirf hum dono wali vibe ke liye.`,
                  }),
                ],
              }),
              (0, x.jsxs)(`div`, {
                ...
                children: [
                  (0, x.jsxs)(`article`, {
                    className: `relation-game reveal`,
                    children: [
                      (0, x.jsxs)(`div`, {
                        className: `game-label`,
                        children: [
                          (0, x.jsx)(`span`, { children: `01` }),
                          (0, x.jsx)(`b`, { children: `Bauniii Hunt` }),
                        ],
                      }),
                      (0, x.jsx)(`h3`, {
                        children: `Dekhein, Aap Bauniii ko kitni jaldi dhoondhti hain?`,
                      }),
                      (0, x.jsx)(`p`, {
                        children: `In sab icons ke beech Bauniii chhupi hain. Bina kisi hint ke dhoondh kar dikhaiye 😌`,
                      }),
                      (0, x.jsx)(`div`, {
                        className: `hunt-board`,
                        children: re.map((e, t) =>
                          (0, x.jsx)(
                            `button`,
                            {
                      ...
                      D &&
                        (0, x.jsxs)(`div`, {
                          ...
                          children: [
                            (0, x.jsx)(`b`, {
                              children: `Mujhe pata tha Aap dhoondh logi 😌`,
                            }),
                            (0, x.jsx)(`span`, {
                              children: `Chaliye, observation test to Aapne clear kar liya.`,
                            }),
                          ],
                        }),
                    ],
                  ...
                  (0, x.jsxs)(`article`, {
                    ...
                    children: [
                      (0, x.jsxs)(`div`, {
                        className: `game-label`,
                        children: [
                          (0, x.jsx)(`span`, { children: `02` }),
                          (0, x.jsx)(`b`, { children: `Ashi Constellation` }),
                        ],
                      }),
                      (0, x.jsx)(`h3`, {
                        children: `Light up your name in the stars ✦`,
                      }),
                      (0, x.jsx)(`p`, {
                        children: `Tap A · S · H · I in the right order and watch your name shine across the sky.`,
                      }),
                      (0, x.jsxs)(`div`, {
                        className: `constellation-board`,
                        children: [
                          (0, x.jsx)(`div`, {
                      ...
                      de === 4 &&
                        (0, x.jsxs)(`div`, {
                          ...
                          children: [
                            (0, x.jsx)(`b`, {
                              children: `Ho gaya—Aap jeet gayi ✦`,
                            }),
                            (0, x.jsx)(`span`, {
                              children: `Ab Aapka naam sky mein bhi shine kar raha hai.`,
                            }),
                          ],
                        }),
                    ],
                  ...
                  (0, x.jsxs)(`article`, {
                    className: `relation-game quiz-game reveal`,
                    children: [
                      (0, x.jsxs)(`div`, {
                        className: `game-label`,
                        children: [
                          (0, x.jsx)(`span`, { children: `03` }),
                          (0, x.jsx)(`b`, { children: `Kitna Yaad Hai?` }),
                        ],
                      }),
                      le
                        ? (0, x.jsxs)(`div`, {
                            ...
                            children: [
                              (0, x.jsx)(`span`, { children: `🏆` }),
                              (0, x.jsxs)(`h3`, {
                                children: [se, `/4 — Royal Score!`],
                              }),
                              (0, x.jsx)(`p`, {
                                children:
                                  se === 4
                                    ? `Aapko to sab pata hai. Ab trophy Aapki aur teasing meri 😭`
                                    : `Score chhota ho sakta hai, par ye quiz tha hi Aapko crown dene ke liye 😌`,
                              }),
                              (0, x.jsx)(`button`, {
                                onClick: () => {
                                  (oe(0), ce(0), E(!1));
                        ...
                        : (0, x.jsxs)(x.Fragment, {
                            children: [
                              ...
                              (0, x.jsx)(`h3`, { children: te[ae].q }),
                              (0, x.jsx)(`div`, {
                                className: `quiz-options`,
                                children: te[ae].options.map((e, t) =>
                                  (0, x.jsxs)(
                                    `button`,
                                    {
                                      onClick: () => Oe(t),
                  ...
                  (0, x.jsxs)(`article`, {
                    className: `relation-game teasing-game reveal`,
                    children: [
                      (0, x.jsxs)(`div`, {
                        className: `game-label`,
                        children: [
                          (0, x.jsx)(`span`, { children: `04` }),
                          (0, x.jsx)(`b`, { children: `Sach-Sach Batana` }),
                        ],
                      }),
                      (0, x.jsx)(`h3`, {
                        children: `Sach bataiye, zyada tease kaun karta hai?`,
                      }),
                      (0, x.jsx)(`p`, {
                        children: `Jhooth mat bolna, mujhe pehle se thoda idea hai Aap kya choose karogi 😭`,
                      }),
                      (0, x.jsx)(`div`, {
                        className: `teasing-options`,
                        children: [
                          `Aap karti hain 😇`,
                          `Main karta hoon 😏`,
                          `Dono barabar hain 😂`,
                          ...
                          (0, x.jsxs)(
                            `button`,
                            {
                              className: k === t ? `selected` : ``,
                              onClick: () => me(t),
                              children: [
                                (0, x.jsx)(`span`, {
                                  children: t === 0 ? `A` : t === 1 ? `L` : `♡`,
                                }),
                                (0, x.jsx)(`b`, { children: e }),
                              ],
                            },
                      ...
                      k !== null &&
                        (0, x.jsxs)(`div`, {
                          className: `funny-verdict`,
                          "aria-live": `polite`,
                          children: [
                            (0, x.jsx)(`span`, { children: `AB SACH SUNO` }),
                            (0, x.jsx)(`p`, { children: ne[k] }),
                          ],
                        }),
                    ],
                  }),
                  (0, x.jsxs)(`article`, {
                    className: `relation-game call-game reveal`,
                    children: [
                      (0, x.jsxs)(`div`, {
                        className: `game-label`,
                        children: [
                          (0, x.jsx)(`span`, { children: `05` }),
                          (0, x.jsx)(`b`, { children: `Babyyy Ka Prize` }),
                        ],
                      }),
                      (0, x.jsx)(`h3`, {
                        children: `Aaj Babyyy ko kya prize milega?`,
                      }),
                      (0, x.jsx)(`p`, {
                        children: `Wheel ghumaiye. Jis prize par rukega, woh Aapka—aur phir main cheating nahi kar sakta 😭`,
                      }),
                      (0, x.jsxs)(`button`, {
                        className: `mission-wheel ${_e ? `spinning` : ``}`,
                        onClick: () => {
                          _e ||
                            (ve(!0),
                            window.setTimeout(() => {
                              (ge((e) => {
                                let t = Math.floor(Math.random() * T.length);
                                return (t === e && (t = (t + 1) % T.length), t);
                              }),
                                ve(!1));
                            }, 520));
                        },
                        disabled: _e,
                        "aria-label": `Babyyy ka prize choose karne ke liye wheel ghumaiye`,
                        children: [
                          (0, x.jsx)(`span`, { children: `✦` }),
                          (0, x.jsx)(`b`, {
                            children: _e ? `choosing…` : `tap`,
                          }),
                          (0, x.jsx)(`i`, { children: `♡` }),
                        ],
                      }),
                      (0, x.jsxs)(`div`, {
                        className: `mission-result ${he >= 0 ? `show` : ``}`,
                        "aria-live": `polite`,
                        children: [
                          (0, x.jsx)(`small`, {
                            children:
                              he >= 0 ? `AAPKA PRIZE` : `PEHLE WHEEL GHUMAIYE`,
                          }),
                          (0, x.jsx)(`p`, {
                            children:
                              he >= 0
                                ? T[he]
                                : `Dekhte hain aaj Babyyy kya jeetengi 😌`,
                          }),
                        ],
                      }),
                    ],
              ...
              (0, x.jsxs)(`div`, {
                className: `funny-facts reveal`,
                "aria-label": `Our funny relationship facts`,
                children: [
                  (0, x.jsxs)(`span`, {
                    children: [
                      (0, x.jsx)(`b`, { children: `01` }),
                      ` Aap gussa hoti hain, main aur tease karta hoon`,
                    ],
                  }),
                  (0, x.jsxs)(`span`, {
                    children: [
                      (0, x.jsx)(`b`, { children: `02` }),
                      ` Video call ka “bye” kabhi final bye nahi hota`,
                    ],
                  }),
                  (0, x.jsxs)(`span`, {
                    children: [
                      (0, x.jsx)(`b`, { children: `03` }),
                      ` Hum dono ek-doosre ko irritate karke khud haste hain`,
                    ],
                  }),
                  (0, x.jsxs)(`span`, {
                    children: [
                      (0, x.jsx)(`b`, { children: `04` }),
                      ` Phir bhi bina baat kiye din adhura lagta hai`,
                    ],
                  }),
                ],
              }),
          ...
          (0, x.jsx)(`section`, {
            className: `melody-section`,
            id: `melody`,
            children: (0, x.jsxs)(`div`, {
              className: `melody-card reveal`,
              children: [
                (0, x.jsxs)(`div`, {
                  className: `melody-record is-playing`,
                  "aria-hidden": `true`,
                  children: [
                    (0, x.jsx)(`span`, { children: `JVKE` }),
                    (0, x.jsx)(`i`, { children: `♡` }),
                  ],
                }),
                (0, x.jsxs)(`div`, {
                  className: `melody-copy`,
                  children: [
                    (0, x.jsx)(`span`, {
                      children: `a song Ali picked for Ashi`,
                    }),
                    (0, x.jsxs)(`h2`, {
                      children: [
                        (0, x.jsx)(`em`, { children: `pretty` }),
                        (0, x.jsx)(`br`, {}),
                        `by JVKE`,
                      ],
                    }),
                ...
                (0, x.jsxs)(`div`, {
                  className: `dedication-lines`,
                  "aria-label": `A note from Ali`,
                  children: [
                    (0, x.jsx)(`span`, {
                      children: `For every ordinary moment you make memorable.`,
                    }),
                    (0, x.jsx)(`span`, {
                      children: `For every call that becomes a favourite memory.`,
                    }),
                    (0, x.jsx)(`span`, {
                      children: `For the smile this song was chosen to find.`,
                    }),
                  ],
                }),
                (0, x.jsxs)(`div`, {
                  className: `melody-bars is-playing`,
                  "aria-hidden": `true`,
                  children: [
                    (0, x.jsx)(`i`, {}),
                    (0, x.jsx)(`i`, {}),
          ...
          (0, x.jsxs)(`aside`, {
            ...
            children: [
              (0, x.jsx)(`i`, { children: `♡` }),
              (0, x.jsx)(`span`, { children: `For you, always` }),
              (0, x.jsx)(`b`, {
                children: `with more love than one song could ever hold`,
              }),
              (0, x.jsx)(`i`, { children: `♡` }),
            ],
          }),
          (0, x.jsxs)(`section`, {
            ...
            children: [
              (0, x.jsxs)(`div`, {
                className: `dream-copy reveal`,
                children: [
                  (0, x.jsx)(`span`, { children: `a tiny pause in the story` }),
                  (0, x.jsx)(`p`, {
                    className: `handwriting`,
                    children: `If comfort were a place…`,
                  }),
                  (0, x.jsxs)(`h2`, {
                    children: [
                      ...
                      (0, x.jsx)(`br`, {}),
                      `like `,
                      (0, x.jsx)(`em`, { children: `this.` }),
                    ],
                  }),
                  (0, x.jsx)(`p`, {
                    children: `A quiet moon, warm lights, too many flowers and two tiny characters simply enjoying the same sky.`,
                  }),
                ],
              }),
              (0, x.jsxs)(`div`, {
                className: `dream-art reveal`,
                children: [
                  (0, x.jsx)(`img`, {
                    src: `./assets/storybook-bear-cat.webp`,
                    alt: `Original bear and cat in a moonlit pastel castle garden`,
                    width: `800`,
                    height: `1200`,
                    loading: `lazy`,
                    decoding: `async`,
          ...
          (0, x.jsxs)(`section`, {
            ...
            children: [
              (0, x.jsxs)(`div`, {
                ...
                children: [
                  (0, x.jsx)(`span`, {
                    children: `the final chapter · sealed for bauniii`,
                  }),
                  (0, x.jsxs)(`h2`, {
                    children: [
                      `One last page,`,
                      (0, x.jsx)(`br`, {}),
                      (0, x.jsx)(`em`, { children: `only for Ashi` }),
                    ],
                  }),
                ],
              }),
              (0, x.jsxs)(`div`, {
                className: `letter-scene reveal`,
                children: [
                  ye
                    ? (0, x.jsxs)(`article`, {
                        className: `opened-scroll`,
                        children: [
                          (0, x.jsx)(`span`, { className: `scroll-rod top` }),
                          (0, x.jsx)(`span`, {
                            className: `scroll-rod bottom`,
                          }),
                          (0, x.jsx)(`small`, {
                            children: `1st August · Girlfriend Day`,
                          }),
                          (0, x.jsx)(`p`, {
                            className: `handwriting`,
                            children: `Dear Ashi,`,
                          ...
                          (0, x.jsx)(`p`, {
                            children: `Aap meri zindagi mein sirf important nahi hain. Aapke saath judi chhoti-chhoti baatein mere din ka woh hissa ban chuki hain jise main sach mein sambhal kar rakhna chahta hoon.`,
                          }),
                          (0, x.jsx)(`p`, {
                            children: `Aapki khoobsurti Aapke andaaz, Aapki kindness, Aapki hansi, Aapke silly side aur Aapki chhoti-chhoti aadaton mein hai. In sabko milakar hi Aap woh Ashi banti hain jo mere liye itni khaas hain.`,
                          }),
                          (0, x.jsx)(`p`, {
                            children: `Mere liye Aapki importance kisi ek din ya celebration tak limited nahi hai. Main bas chahta hoon ki Aapko hamesha pata rahe ki meri life mein Aapki jagah bahut special hai.`,
                          }),
                          (0, x.jsx)(`p`, {
                            children: `Bas Aapka Aap hona hi mere liye bahut hai. Meri favourite conversations aur meri sabse pyaari memories mein Aap hamesha rahengi.`,
                          }),
                          (0, x.jsx)(`strong`, {
                            children: `Happy Girlfriend Day, Ashi ♡`,
                          }),
                          (0, x.jsx)(`i`, { children: `— Hamesha Aapka, Ali` }),
                        ],
                      })
                    : (0, x.jsxs)(`button`, {
                        className: `royal-envelope`,
                        onClick: () => be(!0),
                        children: [
                          (0, x.jsx)(`span`, { className: `envelope-top` }),
                          (0, x.jsxs)(`i`, {
                            className: `seal`,
                            children: [`A`, (0, x.jsx)(`b`, { children: `♡` })],
                          }),
                          (0, x.jsx)(`strong`, { children: `For Ashi` }),
                          (0, x.jsx)(`small`, {
                            children: `tap to break the royal seal`,
                          }),
                        ],
                      }),
                  (0, x.jsxs)(`div`, {
                    className: `letter-pet pet-left`,
                    children: [
                      `🐻`,
                      (0, x.jsx)(`span`, { children: `waiting…` }),
                    ],
                  }),
                  (0, x.jsxs)(`div`, {
                    className: `letter-pet pet-right`,
                    children: [
                      `🐱`,
                      (0, x.jsx)(`span`, { children: `open it!` }),
                    ],
                  }),
                ],
              }),
          ...
          (0, x.jsxs)(`section`, {
            ...
            children: [
              (0, x.jsxs)(`div`, {
                ...
                children: [
                  (0, x.jsx)(`span`, {
                    children: `one more thing · please remember this`,
                  }),
                  (0, x.jsxs)(`h2`, {
                    children: [
                      `Babyyy, ek baat`,
                      (0, x.jsx)(`br`, {}),
                      (0, x.jsx)(`em`, { children: `hamesha yaad rakhna` }),
                    ],
                  }),
                  (0, x.jsx)(`p`, {
                    children: `Jab overthinking zyada ho, tab is note ko ek baar phir padh lena.`,
                  }),
                ],
              }),
              (0, x.jsx)(`div`, {
                className: `reassurance-wrap reveal`,
                children: xe
                  ? (0, x.jsxs)(`article`, {
                      className: `reassurance-paper`,
                      children: [
                        (0, x.jsx)(`small`, {
                          children: `JAB OVERTHINKING ZYADA HO`,
                        }),
                        (0, x.jsx)(`p`, {
                          className: `handwriting`,
                          children: `Dear Babyyy,`,
                        }),
                        (0, x.jsx)(`p`, {
                          children: `Main jaanta hoon ki kabhi-kabhi Aap overthink karti hain ki main Aapki harkaton se pareshan ho gaya hoon, Aapse irritate ho chuka hoon, ya ab Aapse baat karke bore hota hoon. Shayad mera koi short reply, thodi si khamoshi ya kisi moment ka gussa Aapko aisa sochne par majboor kar deta hai. Isliye aaj main ye baat bilkul seedhe aur clearly kehna chahta hoon—main na Aapse pareshan hua hoon aur na hi Aapse bore hua hoon.`,
                        }),
                        (0, x.jsx)(`p`, {
                          children: `Betaaa, main ye nahi kahunga ki mujhe kabhi gussa ya irritation hoti hi nahi. Kabhi mood off ho sakta hai, koi baat achhi nahi lag sakti, ya main thoda quiet ho sakta hoon. Lekin kisi ek situation se irritate hona aur Aapse thak jaana ek hi baat nahi hai. Ek moment ka mood badal sakta hai; meri life mein Aapki importance uske saath nahi badalti.`,
                        }),
                        (0, x.jsx)(`p`, {
                          children: `Agar main Aapse bore hota, to hamari random video calls, bina kisi topic ki baatein, Aapka gussa, hamari teasing aur call ke end par baar-baar bola gaya “bye” mujhe itna yaad nahi rehta. Ye chhoti-chhoti cheezein mere liye boring nahi hain—yehi to hamari baaton ko hamara banati hain.`,
                        }),
                        (0, x.jsx)(`p`, {
                          children: `Aapki kuch harkatein mujhe hasa deti hain, kuch par main Aapko aur tease karta hoon, aur kabhi kisi baat par hum dono ki nok-jhok bhi ho sakti hai. Par iska matlab ye nahi ki main Aapka koi easier ya alag version chahta hoon. Aapki silly baatein, teasing, care, overthinking aur gussa—ye sab milkar hi Aapko meri Betuuu banate hain.`,
                        }),
                        (0, x.jsx)(`p`, {
                          children: `Kabhi mujhe thoda time chahiye ho ya main turant sahi words mein reply na kar paun, to please use meri feelings ka final answer mat samajhna. Thodi der ki khamoshi ka matlab ye nahi ki main Aapse door jaana chahta hoon. Kabhi-kabhi insaan ko bas apna mood samajhne aur calmly baat karne ke liye thoda waqt chahiye hota hai.`,
                        }),
                        (0, x.jsx)(`p`, {
                          children: `Aur agar mujhe sach mein kabhi koi problem hogi, main Aapse seedha bataunga. Main nahi chahta ki Aap mere ek reply ko baar-baar padhkar khud hi sabse bura meaning nikaal lein. Aapko guess karte rehne ki zarurat nahi hai; hum baat karke cheezein samajh sakte hain.`,
                        }),
                        (0, x.jsx)(`p`, {
                          children: `Babyyy, Aap mere liye burden nahi hain. Aapka mujhse baat karna, apni feelings batana ya reassurance maangna mujhe Aapse bore nahi karta. Main chahta hoon ki jab Aapka mind bahut saare “what if” banaye, tab Aap is ek simple truth ko yaad rakhein: ek irritated moment hamare beech ki saari achhi cheezon ko erase nahi karta.`,
                        }),
                        (0, x.jsx)(`p`, {
                          children: `Main Aapse pareshan nahi hoon. Main Aapse bore nahi hua hoon. Main bas kabhi-kabhi kisi situation, kisi baat ya apne mood se irritate ho sakta hoon—aur woh feeling temporary hoti hai. Aapke liye meri care aur Aapki importance ko us ek moment se measure mat kijiye.`,
                        }),
                        (0, x.jsx)(`p`, {
                          children: `Isliye jab bhi overthinking kahe ki “Ali ab mujhse thak gaya hai,” to us thought par turant bharosa mat karna. Pehle mujhse baat karna. Main Aapko honestly bataunga, samjhaunga aur Aapki baat bhi sununga. Har chhoti nok-jhok ke baad bhi Aap mere liye wahi special Babyyy rehti hain.`,
                        }),
                        (0, x.jsx)(`strong`, {
                          children: `Bas itna yaad rakhiye, Betuuu: main Aapse pareshan nahi hua, main Aapse bore nahi hua, aur ek chhota sa gussa Aapki jagah kabhi nahi badalta. ♡`,
                        }),
                        (0, x.jsx)(`i`, { children: `— Ali` }),
                      ],
                    })
                  : (0, x.jsxs)(`button`, {
                      ...
                      children: [
                        (0, x.jsx)(`span`, {
                          className: `reassurance-heart`,
                          "aria-hidden": `true`,
                          children: `♡`,
                        }),
                        (0, x.jsx)(`small`, {
                          children: `ek aur chhota sa note`,
                        }),
                        (0, x.jsx)(`strong`, {
                          children: `Betuuu, ye bhi padhna…`,
                        }),
                        (0, x.jsx)(`p`, {
                          children: `Jab lage ki main Aapse pareshan ya bore ho gaya hoon.`,
                        }),
                        (0, x.jsx)(`i`, { children: `tap to open →` }),
                      ],
                    }),
              }),
            ],
          ...
          (0, x.jsxs)(`section`, {
            className: `love-finale`,
            "aria-label": `A final message from Ali`,
            children: [
              (0, x.jsx)(`div`, {
                className: `finale-stars`,
                "aria-hidden": `true`,
              ...
              (0, x.jsxs)(`article`, {
                className: `forever-card reveal`,
                children: [
                  (0, x.jsxs)(`div`, {
                    className: `forever-orbit`,
                    "aria-hidden": `true`,
                    children: [
                      (0, x.jsx)(`i`, { children: `♡` }),
                      (0, x.jsx)(`i`, { children: `✦` }),
                  ...
                  (0, x.jsx)(`small`, {
                    children: `one last truth · from ali`,
                  }),
                  (0, x.jsx)(`span`, {
                    className: `forever-heart`,
                    "aria-hidden": `true`,
                    children: `♡`,
                  }),
                  (0, x.jsxs)(`h2`, {
                    children: [
                      ...
                      (0, x.jsx)(`br`, {}),
                      (0, x.jsx)(`em`, {
                        children: `beyond every expectation.`,
                      }),
                    ],
                  }),
                  (0, x.jsxs)(`div`, {
                    className: `forever-divider`,
                    children: [(0, x.jsx)(`i`, {}), `♡`, (0, x.jsx)(`i`, {})],
                  }),
                  (0, x.jsx)(`p`, {
                    children: `Ashi, this page may end here, but Ali's care for you is not something that becomes smaller with time. It is bigger than one special day, bigger than ordinary words, and far beyond anything a single card could ever explain.`,
                  }),
                  (0, x.jsx)(`p`, {
                    children: `You are loved in the quiet moments, in the long calls, in the laughter after teasing, and in all the completely normal days that become memorable because you are part of them. Even when a day feels difficult, the respect, patience, care and effort behind these pages still remain.`,
                  }),
                  (0, x.jsx)(`p`, {
                    children: `Some feelings are simply too large for perfect sentences. So let this ending hold one clear truth: you are deeply valued, wonderfully special, and loved beyond every expectation—further than imagination can reach and more than all these pages could ever hold.`,
                  }),
                  (0, x.jsx)(`strong`, { children: `I LOVE YOU, BETAAA ♡` }),
                  (0, x.jsxs)(`blockquote`, {
                    children: [
                      `More than every sentence written here.`,
                      (0, x.jsx)(`br`, {}),
                      `More than this little world could ever show.`,
                    ],
                  }),
                  (0, x.jsxs)(`footer`, {
                    children: [
                      (0, x.jsx)(`span`, {
                        children: `with more love than words can carry,`,
                      }),
                      (0, x.jsx)(`b`, { children: `Ali` }),
                    ],
                  }),
                ],
              }),
          ...
          (0, x.jsxs)(`footer`, {
            className: `grand-footer`,
            children: [
              (0, x.jsx)(`div`, { className: `crown`, children: `♔` }),
              (0, x.jsx)(`h2`, { children: `Ashi’s little world` }),
              (0, x.jsx)(`p`, {
                children: `made with care, a ridiculous number of hearts & a little royal magic`,
              }),
              (0, x.jsxs)(`div`, {
                className: `footer-names`,
                children: [
                  (0, x.jsx)(`span`, { children: `ALI` }),
                  (0, x.jsx)(`i`, { children: `♡` }),
                  (0, x.jsx)(`span`, { children: `ASHI` }),
                ],
              }),
              (0, x.jsx)(`small`, {
                children: `the end of this page · not the end of the story`,
              }),
            ],
          }),
        ],
    ...
    : (0, x.jsxs)(`main`, {
        ...
        children: [
          ...
          (0, x.jsxs)(`div`, {
            ...
            children: [
              (0, x.jsx)(`span`, { className: `tiny-crown`, children: `♔` }),
              (0, x.jsx)(`p`, { children: `A magical little world awaits` }),
              (0, x.jsxs)(`h1`, {
                children: [`For `, (0, x.jsx)(`em`, { children: `Ashi` })],
              }),
              (0, x.jsxs)(`div`, {
                className: `entry-seal`,
                children: [
                  (0, x.jsx)(`span`, { children: `A` }),
                  (0, x.jsx)(`i`, { children: `♡` }),
                ],
              }),
              (0, x.jsx)(`small`, {
                children: `also known as the cutest “Bauniii”`,
              }),
              (0, x.jsxs)(`button`, {
                onClick: () => t(!0),
                children: [
              ...
              (0, x.jsx)(`b`, {
                className: `tap-hint`,
                children: `tap anywhere for magic ✦`,
              }),
            ],
          }),
          (0, x.jsx)(`div`, { className: `entry-cloud c1`, children: `☁️` }),
          (0, x.jsx)(`div`, { className: `entry-cloud c2`, children: `☁️` }),
        ],
      });
}
y.createRoot(document.getElementById(`root`)).render(
  (0, x.jsx)(b.StrictMode, { children: (0, x.jsx)(ae, {}) }),
);
